  ...
  return (
    <div className={s.header}>
      ...
      <div className={s.toFav}>
        ...
        <Link to='/favourites' className={s.links}>Favourites</Link>
      </div>
      {!searchValue && <Popover placement="bottom" content={content} trigger='click' open={isOpen} onOpenChange={handleOpenChange} className={s.typesFilter}>
